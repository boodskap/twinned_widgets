...
class DeviceFieldDynamicValueCompareWidgetBuilder extends TwinnedWidgetBuilder {
  @override
  Widget build(Map<String, dynamic> config) {
    return DynamicValueCompareWidget(
        config: DynamicValueCompareWidgetConfig.fromJson(config));
  }
  ...
  String getPaletteName() {
    return "Device Field Dynamic value Compare Widget";
  }

  @override
  BaseConfig getDefaultConfig({Map<String, dynamic>? config}) {
    if (null != config) {
      return DynamicValueCompareWidgetConfig.fromJson(config);
    }
    return DynamicValueCompareWidgetConfig();
  }
